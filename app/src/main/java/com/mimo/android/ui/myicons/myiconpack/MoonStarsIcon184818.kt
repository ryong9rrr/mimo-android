...
public val MyIconPack.MoonStarsIcon184818: ImageVector
    get() {
        if (_moonStarsIcon184818 != null) {
            return _moonStarsIcon184818!!
        }
        _moonStarsIcon184818 = Builder(name = "MoonStarsIcon184818", defaultWidth = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(7.269f, 7.269f, 0.0f, false, false, 1.025f, 7.71f)
                curveToRelative(0.0f, 4.02f, 3.279f, 7.276f, 7.319f, 7.276f)
                arcToRelative(7.316f, 7.316f, 0.0f, false, false, 5.205f, -2.162f)
                curveToRelative(-0.337f, 0.042f, -0.68f, 0.063f, -1.029f, 0.063f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-1.162f, 0.387f)
                arcToRelative(1.734f, 1.734f, 0.0f, false, false, -1.097f, 1.097f)
                lineToRelative(-0.387f, 1.162f)
                arcToRelative(0.217f, 0.217f, 0.0f, false, true, -0.412f, 0.0f)
                lineToRelative(-0.387f, -1.162f)
                arcTo(1.734f, 1.734f, 0.0f, false, false, 9.31f, 6.593f)
                lineToRelative(-1.162f, -0.387f)
                arcToRelative(0.217f, 0.217f, 0.0f, false, true, 0.0f, -0.412f)
                lineToRelative(1.162f, -0.387f)
                arcToRelative(1.734f, 1.734f, 0.0f, false, false, 1.097f, -1.097f)
...
private var _moonStarsIcon184818: ImageVector? = null
